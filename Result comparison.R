...
plotoutput <- function() {
par(mfrow = c(4,1), mar = c(4,9.7,1,6),oma = c(4,0,0,0))
#A. Temperature
...
axis(side = 1, at = plot.day,
     cex.axis = 3.5,lwd.ticks = 2,tck = -0.02,mgp = c(0,2,0),
...
axis(side = 1, at = plot.day,
     cex.axis = 3.5,lwd.ticks = 1,tck = -0.02,mgp = c(0,2,0),
     labels = plot.date, font = 2)
mtext("Date",line = 2.5 , cex = 4,side = 1,
      outer = T)
